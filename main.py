...
class OurNeuralNetwork:
    ...
    *** DISCLAIMER ***:
    ...
    def train(self, data, all_y_trues):
        ...
        '''
        learn_rate = 0.1
        result = [['epoch', 'loss', 'w1', 'w2', 'w3', 'w4', 'w5', 'w6', 'b1', 'b2', 'b3']]
        ...
        for epoch in range(epochs):
            ...
            if epoch % 10 == 0:
                ...
                print(
                    "Epoch %d loss: %.3f --- w1: %.3f w2: %.3f w3: %.3f w4: %.3f w5: %.3f w6: %.3f b1: %.3f b2: %.3f b3: %.3f" % (
                        epoch, loss, self.w1, self.w2, self.w3, self.w4, self.w5, self.w6, self.b1, self.b2, self.b3))
                result.append(
                    [epoch, loss, self.w1, self.w2, self.w3, self.w4, self.w5, self.w6, self.b1, self.b2, self.b3])
        csv.writer(open("result.csv", "w", newline='')).writerows(result)
